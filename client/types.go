...
type SendMessageRequest struct {
	...
	Configuration *a2a.SendMessageConfiguration `json:"configuration,omitempty"`
}
...
func (r *SendMessageRequest) toJSONRPC() *a2a.SendMessageRequest {
	return &a2a.SendMessageRequest{
		...
		Params: a2a.SendMessageParams{
			...
			TaskID:  "", // Will be set based on configuration
		},
		ID: r.ID,
	}
}
