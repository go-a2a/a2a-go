...
const file_a2a_proto_rawDesc = "" +
	...
	"\bblocking\x18\x04 \x01(\bR\bblocking\"\xf1\x01\n" +
	"\x04Task\x12\x0e\n" +
	...
	"\x04file\"7\n" +
	"\bDataPart\x12+\n" +
	"\x04data\x18\x01 \x01(\v2\x17.google.protobuf.StructR\x04data\"\xff\x01\n" +
	"\aMessage\x12\x1d\n" +
	"\n" +
	...
	"inputModes\x12!\n" +
	"\foutput_modes\x18\a \x03(\tR\voutputModes\"\x8a\x01\n" +
	...
	"\arequest\x18\x01 \x01(\v2\x0f.a2a.v1.MessageB\x03\xe0A\x02R\arequest\x12F\n" +
	...
	" DeleteTaskPushNotificationConfig\x12/.a2a.v1.DeleteTaskPushNotificationConfigRequest\x1a\x16.google.protobuf.Empty\";\xdaA\x04name\x82\xd3\xe4\x93\x02.*,/v1/{name=tasks/*/pushNotificationConfigs/*}B=\n" +
...
var (
	file_a2a_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
	file_a2a_proto_msgTypes  = make([]protoimpl.MessageInfo, 49)
	file_a2a_proto_goTypes   = []any{
		...
		(*TaskPushNotificationConfig)(nil),              // 20: a2a.v1.TaskPushNotificationConfig
		(*StringList)(nil),                              // 21: a2a.v1.StringList
		(*Security)(nil),                                // 22: a2a.v1.Security
		(*SecurityScheme)(nil),                          // 23: a2a.v1.SecurityScheme
		(*APIKeySecurityScheme)(nil),                    // 24: a2a.v1.APIKeySecurityScheme
		(*HTTPAuthSecurityScheme)(nil),                  // 25: a2a.v1.HTTPAuthSecurityScheme
		(*OAuth2SecurityScheme)(nil),                    // 26: a2a.v1.OAuth2SecurityScheme
		(*OpenIdConnectSecurityScheme)(nil),             // 27: a2a.v1.OpenIdConnectSecurityScheme
		...
		(*SendMessageRequest)(nil),                      // 33: a2a.v1.SendMessageRequest
		(*GetTaskRequest)(nil),                          // 34: a2a.v1.GetTaskRequest
		(*CancelTaskRequest)(nil),                       // 35: a2a.v1.CancelTaskRequest
		(*GetTaskPushNotificationConfigRequest)(nil),    // 36: a2a.v1.GetTaskPushNotificationConfigRequest
		(*DeleteTaskPushNotificationConfigRequest)(nil), // 37: a2a.v1.DeleteTaskPushNotificationConfigRequest
		(*CreateTaskPushNotificationConfigRequest)(nil), // 38: a2a.v1.CreateTaskPushNotificationConfigRequest
		(*TaskSubscriptionRequest)(nil),                 // 39: a2a.v1.TaskSubscriptionRequest
		(*ListTaskPushNotificationConfigRequest)(nil),   // 40: a2a.v1.ListTaskPushNotificationConfigRequest
		(*GetAgentCardRequest)(nil),                     // 41: a2a.v1.GetAgentCardRequest
		(*SendMessageResponse)(nil),                     // 42: a2a.v1.SendMessageResponse
		(*StreamResponse)(nil),                          // 43: a2a.v1.StreamResponse
		(*ListTaskPushNotificationConfigResponse)(nil),  // 44: a2a.v1.ListTaskPushNotificationConfigResponse
		nil,                           // 45: a2a.v1.AgentCard.SecuritySchemesEntry
		nil,                           // 46: a2a.v1.Security.SchemesEntry
		nil,                           // 47: a2a.v1.AuthorizationCodeOAuthFlow.ScopesEntry
		nil,                           // 48: a2a.v1.ClientCredentialsOAuthFlow.ScopesEntry
		nil,                           // 49: a2a.v1.ImplicitOAuthFlow.ScopesEntry
		nil,                           // 50: a2a.v1.PasswordOAuthFlow.ScopesEntry
...
var file_a2a_proto_depIdxs = []int32{
	...
	51, // 4: a2a.v1.Task.metadata:type_name -> google.protobuf.Struct
	0,  // 5: a2a.v1.TaskStatus.state:type_name -> a2a.v1.TaskState
	8,  // 6: a2a.v1.TaskStatus.update:type_name -> a2a.v1.Message
	52, // 7: a2a.v1.TaskStatus.timestamp:type_name -> google.protobuf.Timestamp
	6,  // 8: a2a.v1.Part.file:type_name -> a2a.v1.FilePart
	7,  // 9: a2a.v1.Part.data:type_name -> a2a.v1.DataPart
	51, // 10: a2a.v1.DataPart.data:type_name -> google.protobuf.Struct
	1,  // 11: a2a.v1.Message.role:type_name -> a2a.v1.Role
	5,  // 12: a2a.v1.Message.content:type_name -> a2a.v1.Part
	51, // 13: a2a.v1.Message.metadata:type_name -> google.protobuf.Struct
	5,  // 14: a2a.v1.Artifact.parts:type_name -> a2a.v1.Part
	51, // 15: a2a.v1.Artifact.metadata:type_name -> google.protobuf.Struct
	4,  // 16: a2a.v1.TaskStatusUpdateEvent.status:type_name -> a2a.v1.TaskStatus
	51, // 17: a2a.v1.TaskStatusUpdateEvent.metadata:type_name -> google.protobuf.Struct
	9,  // 18: a2a.v1.TaskArtifactUpdateEvent.artifact:type_name -> a2a.v1.Artifact
	51, // 19: a2a.v1.TaskArtifactUpdateEvent.metadata:type_name -> google.protobuf.Struct
	13, // 20: a2a.v1.PushNotificationConfig.authentication:type_name -> a2a.v1.AuthenticationInfo
	14, // 21: a2a.v1.AgentCard.additional_interfaces:type_name -> a2a.v1.AgentInterface
	16, // 22: a2a.v1.AgentCard.provider:type_name -> a2a.v1.AgentProvider
	17, // 23: a2a.v1.AgentCard.capabilities:type_name -> a2a.v1.AgentCapabilities
	45, // 24: a2a.v1.AgentCard.security_schemes:type_name -> a2a.v1.AgentCard.SecuritySchemesEntry
	22, // 25: a2a.v1.AgentCard.security:type_name -> a2a.v1.Security
	19, // 26: a2a.v1.AgentCard.skills:type_name -> a2a.v1.AgentSkill
	18, // 27: a2a.v1.AgentCapabilities.extensions:type_name -> a2a.v1.AgentExtension
	51, // 28: a2a.v1.AgentExtension.params:type_name -> google.protobuf.Struct
	12, // 29: a2a.v1.TaskPushNotificationConfig.push_notification_config:type_name -> a2a.v1.PushNotificationConfig
	46, // 30: a2a.v1.Security.schemes:type_name -> a2a.v1.Security.SchemesEntry
	24, // 31: a2a.v1.SecurityScheme.api_key_security_scheme:type_name -> a2a.v1.APIKeySecurityScheme
	25, // 32: a2a.v1.SecurityScheme.http_auth_security_scheme:type_name -> a2a.v1.HTTPAuthSecurityScheme
	26, // 33: a2a.v1.SecurityScheme.oauth2_security_scheme:type_name -> a2a.v1.OAuth2SecurityScheme
	27, // 34: a2a.v1.SecurityScheme.open_id_connect_security_scheme:type_name -> a2a.v1.OpenIdConnectSecurityScheme
	28, // 35: a2a.v1.OAuth2SecurityScheme.flows:type_name -> a2a.v1.OAuthFlows
	29, // 36: a2a.v1.OAuthFlows.authorization_code:type_name -> a2a.v1.AuthorizationCodeOAuthFlow
	30, // 37: a2a.v1.OAuthFlows.client_credentials:type_name -> a2a.v1.ClientCredentialsOAuthFlow
	31, // 38: a2a.v1.OAuthFlows.implicit:type_name -> a2a.v1.ImplicitOAuthFlow
	32, // 39: a2a.v1.OAuthFlows.password:type_name -> a2a.v1.PasswordOAuthFlow
	47, // 40: a2a.v1.AuthorizationCodeOAuthFlow.scopes:type_name -> a2a.v1.AuthorizationCodeOAuthFlow.ScopesEntry
	48, // 41: a2a.v1.ClientCredentialsOAuthFlow.scopes:type_name -> a2a.v1.ClientCredentialsOAuthFlow.ScopesEntry
	49, // 42: a2a.v1.ImplicitOAuthFlow.scopes:type_name -> a2a.v1.ImplicitOAuthFlow.ScopesEntry
	50, // 43: a2a.v1.PasswordOAuthFlow.scopes:type_name -> a2a.v1.PasswordOAuthFlow.ScopesEntry
	8,  // 44: a2a.v1.SendMessageRequest.request:type_name -> a2a.v1.Message
	2,  // 45: a2a.v1.SendMessageRequest.configuration:type_name -> a2a.v1.SendMessageConfiguration
	51, // 46: a2a.v1.SendMessageRequest.metadata:type_name -> google.protobuf.Struct
	20, // 47: a2a.v1.CreateTaskPushNotificationConfigRequest.config:type_name -> a2a.v1.TaskPushNotificationConfig
	3,  // 48: a2a.v1.SendMessageResponse.task:type_name -> a2a.v1.Task
	8,  // 49: a2a.v1.SendMessageResponse.msg:type_name -> a2a.v1.Message
	3,  // 50: a2a.v1.StreamResponse.task:type_name -> a2a.v1.Task
	8,  // 51: a2a.v1.StreamResponse.msg:type_name -> a2a.v1.Message
	10, // 52: a2a.v1.StreamResponse.status_update:type_name -> a2a.v1.TaskStatusUpdateEvent
	11, // 53: a2a.v1.StreamResponse.artifact_update:type_name -> a2a.v1.TaskArtifactUpdateEvent
	20, // 54: a2a.v1.ListTaskPushNotificationConfigResponse.configs:type_name -> a2a.v1.TaskPushNotificationConfig
	23, // 55: a2a.v1.AgentCard.SecuritySchemesEntry.value:type_name -> a2a.v1.SecurityScheme
	21, // 56: a2a.v1.Security.SchemesEntry.value:type_name -> a2a.v1.StringList
	33, // 57: a2a.v1.A2AService.SendMessage:input_type -> a2a.v1.SendMessageRequest
	33, // 58: a2a.v1.A2AService.SendStreamingMessage:input_type -> a2a.v1.SendMessageRequest
	34, // 59: a2a.v1.A2AService.GetTask:input_type -> a2a.v1.GetTaskRequest
	35, // 60: a2a.v1.A2AService.CancelTask:input_type -> a2a.v1.CancelTaskRequest
	39, // 61: a2a.v1.A2AService.TaskSubscription:input_type -> a2a.v1.TaskSubscriptionRequest
	38, // 62: a2a.v1.A2AService.CreateTaskPushNotificationConfig:input_type -> a2a.v1.CreateTaskPushNotificationConfigRequest
	36, // 63: a2a.v1.A2AService.GetTaskPushNotificationConfig:input_type -> a2a.v1.GetTaskPushNotificationConfigRequest
	40, // 64: a2a.v1.A2AService.ListTaskPushNotificationConfig:input_type -> a2a.v1.ListTaskPushNotificationConfigRequest
	41, // 65: a2a.v1.A2AService.GetAgentCard:input_type -> a2a.v1.GetAgentCardRequest
	37, // 66: a2a.v1.A2AService.DeleteTaskPushNotificationConfig:input_type -> a2a.v1.DeleteTaskPushNotificationConfigRequest
	42, // 67: a2a.v1.A2AService.SendMessage:output_type -> a2a.v1.SendMessageResponse
	43, // 68: a2a.v1.A2AService.SendStreamingMessage:output_type -> a2a.v1.StreamResponse
	3,  // 69: a2a.v1.A2AService.GetTask:output_type -> a2a.v1.Task
	3,  // 70: a2a.v1.A2AService.CancelTask:output_type -> a2a.v1.Task
	43, // 71: a2a.v1.A2AService.TaskSubscription:output_type -> a2a.v1.StreamResponse
	20, // 72: a2a.v1.A2AService.CreateTaskPushNotificationConfig:output_type -> a2a.v1.TaskPushNotificationConfig
	20, // 73: a2a.v1.A2AService.GetTaskPushNotificationConfig:output_type -> a2a.v1.TaskPushNotificationConfig
	44, // 74: a2a.v1.A2AService.ListTaskPushNotificationConfig:output_type -> a2a.v1.ListTaskPushNotificationConfigResponse
	15, // 75: a2a.v1.A2AService.GetAgentCard:output_type -> a2a.v1.AgentCard
	53, // 76: a2a.v1.A2AService.DeleteTaskPushNotificationConfig:output_type -> google.protobuf.Empty
...
func file_a2a_proto_init() {
	...
	file_a2a_proto_msgTypes[21].OneofWrappers = []any{
	...
	file_a2a_proto_msgTypes[40].OneofWrappers = []any{
