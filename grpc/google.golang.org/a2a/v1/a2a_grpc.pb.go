...
func _A2AService_SendMessage_Handler(srv any, ctx context.Context, dec func(any) error, interceptor grpc.UnaryServerInterceptor) (any, error) {
...
func _A2AService_SendStreamingMessage_Handler(srv any, stream grpc.ServerStream) error {
...
func _A2AService_GetTask_Handler(srv any, ctx context.Context, dec func(any) error, interceptor grpc.UnaryServerInterceptor) (any, error) {
...
func _A2AService_CancelTask_Handler(srv any, ctx context.Context, dec func(any) error, interceptor grpc.UnaryServerInterceptor) (any, error) {
...
func _A2AService_TaskSubscription_Handler(srv any, stream grpc.ServerStream) error {
...
func _A2AService_CreateTaskPushNotificationConfig_Handler(srv any, ctx context.Context, dec func(any) error, interceptor grpc.UnaryServerInterceptor) (any, error) {
...
func _A2AService_GetTaskPushNotificationConfig_Handler(srv any, ctx context.Context, dec func(any) error, interceptor grpc.UnaryServerInterceptor) (any, error) {
...
func _A2AService_ListTaskPushNotificationConfig_Handler(srv any, ctx context.Context, dec func(any) error, interceptor grpc.UnaryServerInterceptor) (any, error) {
...
func _A2AService_GetAgentCard_Handler(srv any, ctx context.Context, dec func(any) error, interceptor grpc.UnaryServerInterceptor) (any, error) {
...
func _A2AService_DeleteTaskPushNotificationConfig_Handler(srv any, ctx context.Context, dec func(any) error, interceptor grpc.UnaryServerInterceptor) (any, error) {
