...
func CreateSendMessageConfiguration(opts ...SendMessageConfigOption) *a2a.MessageSendConfiguration {
...
func WithPushNotification(pushNotification *a2a.PushNotificationConfig) SendMessageConfigOption {
	return func(config *a2a.MessageSendConfiguration) {
		config.PushNotificationConfig = pushNotification
	}
}
...
func WithHistoryLength(length int32) SendMessageConfigOption {
	return func(config *a2a.MessageSendConfiguration) {
		config.HistoryLength = int(length)
	}
}
...
func CreatePushNotificationConfigWithAuth(id, url, token string, auth *a2a.PushNotificationAuthenticationInfo) *a2a.PushNotificationConfig {
...
func CreateAuthenticationInfo(schemes []string, credentials string) *a2a.PushNotificationAuthenticationInfo {
	return &a2a.PushNotificationAuthenticationInfo{
		Schemes:     schemes,
...
func CreateDefaultSendMessageConfiguration() *a2a.MessageSendConfiguration {
	return &a2a.MessageSendConfiguration{
