	...
	t.Run("Value", func(t *testing.T) {
		testCases := []struct {
			...
			},
			{
				...
				input: TaskStatusJSON{
					TaskStatus: a2a.TaskStatus{State: a2a.TaskStateWorking},
				},
...
func TestArtifactSliceJSON(t *testing.T) {
	...
	testArtifact := a2a.NewArtifact([]a2a.Part{a2a.NewTextPart("test-artifact")}, "test content", "test description")
...
func TestMessageSliceJSON(t *testing.T) {
	testMessage := a2a.Message{
		...
		Parts:     []a2a.Part{a2a.NewTextPart("test content")},
	...
	t.Run("valid task model", func(t *testing.T) {
		tm := &TaskModel{
			TaskMixin: TaskMixin{
				...
				ContextID: "test-context",
				Kind:      "task",
				Status:    TaskStatusJSON{a2a.TaskStatus{State: a2a.TaskStateWorking}},
				Artifacts: ArtifactSliceJSON{Artifacts: []a2a.Artifact{}},
				History:   MessageSliceJSON{Messages: []a2a.Message{}},
				Metadata:  map[string]any{},
			},
